...
<section class="sm:max-h-[80svh] sm:h-[80svh] h-auto flex justify-center items-center">
    <img src="images/dear2.png" alt="dear" class=" absolute h-[90svh]  min-[1550px]:left-[-20%] min-[1450px]:left-[-20%] min-[1024px]:left-[-25%] min-[1200px]:left-[-27%] hidden min-[1024px]:block" >
    <div class="container mx-auto flex flex-col lg:flex-row ">
        ...
        <div class="w-full lg:w-1/2 flex justify-center items-center animate blur-in-down fast-3 bg-white sm:bg-transparent pt-5 sm:pt-0">
