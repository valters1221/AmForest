...
<body>
    ...
    <section>
        <div class="relative h-[600px] flex flex-col justify-between">
            ...
            <div
                class=" bg-zinc-900/80 w-full sm:w-auto rounded-xl p-4 absolute left-1/2 -bottom-12 z-40 backdrop-blur-md  -translate-x-1/2 text-white">
                <div class="flex flex-wrap sm:flex-nowrap justify-between items-stretch">
                    <a href="#"
                        class=" w-1/2 sm:w-1/4 px-7 py-4 flex flex-col items-center justify-center animate blur-grow fast-2">
                    ...
                    <a href="#"
                        class=" w-1/2 sm:w-1/4 px-7 py-4 flex flex-col items-center justify-center animate blur-grow fast-2 delays-1">
                        <div class="text-lg md:text-lg lg:text-lg hover:text-[#309474] transition-colors ">Uzskopšana
                        </div>
                    </a>
                    <div class=" hidden sm:block w-px bg-[#309474] self-stretch"></div>
                    <a href="#"
                        class=" w-1/2 sm:w-1/4 px-7 py-4 flex flex-col items-center justify-center animate blur-grow fast-2 delays-2">
                        <div class="text-lg md:text-lg lg:text-lg hover:text-[#309474] transition-colors tracking-wide">
                            Transports</div>
                    </a>
                    <div class=" hidden sm:block w-px bg-[#309474] self-stretch"></div>
                    <a href="#"
                        class=" w-1/2 sm:w-1/4 px-7 py-4 flex flex-col items-center justify-center animate blur-grow fast-2 delays-3">
    ...
    <section>
        ...
        <div class="w-full max-w-7xl mx-auto px-1 sm:px-4 py-6 sm:py-12">
            ...
            <div class="grid md:grid-cols-3 gap-2 sm:gap-8 lg:gap-12">
                <!-- Card 1 -->
                <div
                    class="relative p-4 sm:p-8 lg:p-12 shadow-xl rounded-[1.5rem] sm:rounded-[2rem] w-[98%] mx-auto sm:w-full bg-white overflow-hidden animate blur-in-down fast-2">
                    <!-- Main Gradient Blur -->
                ...
                <!-- Card 2 -->
                <div
                    class="relative p-4 sm:p-8 lg:p-12 shadow-xl rounded-[1.5rem] sm:rounded-[2rem] w-[98%] mx-auto sm:w-full bg-white overflow-hidden animate blur-in-down fast-2 delays-1">
                    <!-- Main Gradient Blur -->
                    <div class="absolute -top-20 -right-20 w-80 h-80 gradient-blur"></div>
                    <!-- Additional Shine Effect -->
                    <div class="absolute -top-10 -right-10 w-60 h-60 shine-effect"></div>
                ...
                <!-- Card 3 -->
                <div
                    class="relative p-4 sm:p-8 lg:p-12 shadow-xl rounded-[1.5rem] sm:rounded-[2rem] w-[98%] mx-auto sm:w-full bg-white overflow-hidden animate blur-in-down fast-2 delays-2">
                    <!-- Main Gradient Blur -->
                    <div class="absolute -top-20 -right-20 w-80 h-80 gradient-blur"></div>
                    <!-- Additional Shine Effect -->
                    <div class="absolute -top-10 -right-10 w-60 h-60 shine-effect"></div>
