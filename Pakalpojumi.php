   ...
   <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <?php include 'components/header.php' ?>
        <section class="relative overflow-hidden ">
            <img src="images/services.jpg" alt="Forest background" class="absolute inset-0 w-full h-full object-cover  brightness-50 -z-10">
            <div class="container w-full max-w-[1200px] h-[500px]  flex flex-col lg:flex-row space-y-8 lg:space-y-0 mx-auto ">
                <div class=" w-full h-full  lg:w-1/2 flex justify-center items-center h">
                    <div class="w-full p-4 sm:p-0">
                        <h1 class=" text-4xl sm:text-6xl w-full font-medium text-white"><?php echo __('services.text1'); ?></h1>
                        <p class=" text-xl sm:text-2xl w-[90%] sm:w-full text-zinc-200 mt-3"><?php echo __('services.text2'); ?></p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="grid sm:grid-cols-2 gap-5 sm:gap-3">
                ...
                <div class="bg-white border border-solid border-[#3d5735] rounded-xl overflow-hidden ">
                    <div class="p-6">
                        ...
                        <a href="#" class="inline-block bg-zinc-800 text-white px-6 py-2 rounded-full text-sm hover:bg-zinc-700 transition-colors">
